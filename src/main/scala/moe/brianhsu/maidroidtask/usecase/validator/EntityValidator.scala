...
import moe.brianhsu.maidroidtask.gateway.repo.UserBasedReadable
...
object EntityValidator {
  ...
  def allExist[T](uuidList: List[UUID])(implicit readable: UserBasedReadable[T]): Option[ErrorDescription] = {
  ...
  def noCollision[T](uuid: UUID)(implicit readable: UserBasedReadable[T]): Option[ErrorDescription] = {
  ...
  def exist[T](uuid: UUID)(implicit readable: UserBasedReadable[T]): Option[ErrorDescription] = {
