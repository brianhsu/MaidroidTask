...
class UseCaseValidationSpec extends AnyFeatureSpec with GivenWhenThen {
  ...
  Feature("Validate request") {
    ...
    Scenario("There is one validation, and the validation passed") {
      ...
      object useCase extends DoNothingUseCase {
        ...
        override def validations: List[ValidationRules] = createValidator(fieldName = "value", value, checkValueLargeThenZero)
      }
    ...
    Scenario("There is one validation, and the validation failed") {
      ...
      object useCase extends DoNothingUseCase {
        ...
        override def validations: List[ValidationRules] = createValidator(fieldName = "value", value, checkValueLargeThenTen)
      }
    ...
    Scenario("There are multiple validations, and the validation pass") {
      ...
      object useCase extends DoNothingUseCase {
        ...
        override def validations: List[ValidationRules] = createValidator(fieldName = "value", value, largeThenTen, largeThenZero)
      }
    ...
    Scenario("There are multiple validations, and one of the validation failed") {
      ...
      object useCase extends DoNothingUseCase {
        ...
        override def validations: List[ValidationRules] = createValidator(fieldName = "value", value, largeThenTen, largeThen1000)
      }
